...
PIN_TOOL=/mnt/e/pin/parsec-3.0/advcomparch-22-ex2-helpcode/pintool/obj-intel64/cslab_branch.so
outDir="/mnt/e/pin/parsec-3.0/advcomparch-22-ex2-helpcode/sims"
...
for BENCH in $BENCHMARKS; do
	...
	pinOutFile="$outDir/${BENCH}.4_2_i.out"
