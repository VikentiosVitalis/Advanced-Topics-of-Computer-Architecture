...
os.chdir(r'/mnt/e/pin/parsec-3.0/advcomparch-22-ex2-helpcode/sims/4_1')
...
for outFile in files:
    ...
    stats = "Benchmark %r" %BenchmarkName + '\n Total Branches: ' + str(int(totalBranches)) + " - {:.2f}% ".format(percentage)  + "of total instructions"
